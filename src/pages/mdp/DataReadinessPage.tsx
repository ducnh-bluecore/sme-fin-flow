...
const fieldDescriptions: Record<string, Record<string, { vi: string; en: string; type: string; example: string }>> = {
  external_orders: {
    ...
    order_date: { vi: 'Ngày đặt hàng', en: 'Order date', type: 'date', example: '2026-01-15' },
    status: { vi: 'Trạng thái đơn hàng', en: 'Order status', type: 'text', example: 'completed' },
    total_amount: { vi: 'Tổng tiền đơn hàng', en: 'Total amount', type: 'number', example: '500000' },
    payment_status: { vi: 'Trạng thái thanh toán', en: 'Payment status', type: 'text', example: 'paid' },
    cost_of_goods: { vi: 'Giá vốn hàng bán', en: 'Cost of goods sold', type: 'number', example: '300000' },
    seller_income: { vi: 'Thu nhập thực nhận từ sàn', en: 'Net seller income', type: 'number', example: '450000' },
  },
  external_order_items: {
    product_name: { vi: 'Tên sản phẩm', en: 'Product name', type: 'text', example: 'Áo thun nam' },
    quantity: { vi: 'Số lượng', en: 'Quantity', type: 'number', example: '2' },
    unit_price: { vi: 'Đơn giá bán', en: 'Unit price', type: 'number', example: '250000' },
    cost_price: { vi: 'Giá vốn', en: 'Cost price', type: 'number', example: '150000' },
  },
  promotion_campaigns: {
    campaign_name: { vi: 'Tên chiến dịch', en: 'Campaign name', type: 'text', example: 'Flash Sale 1.1' },
    channel: { vi: 'Kênh quảng cáo', en: 'Ad channel', type: 'text', example: 'facebook' },
    actual_cost: { vi: 'Chi phí thực tế', en: 'Actual spend', type: 'number', example: '5000000' },
    total_revenue: { vi: 'Doanh thu từ campaign', en: 'Campaign revenue', type: 'number', example: '25000000' },
    start_date: { vi: 'Ngày bắt đầu', en: 'Start date', type: 'date', example: '2026-01-01' },
    end_date: { vi: 'Ngày kết thúc', en: 'End date', type: 'date', example: '2026-01-07' },
  },
  marketing_expenses: {
    channel: { vi: 'Kênh quảng cáo', en: 'Ad channel', type: 'text', example: 'google_ads' },
    expense_date: { vi: 'Ngày chi tiêu', en: 'Expense date', type: 'date', example: '2026-01-15' },
    amount: { vi: 'Số tiền chi', en: 'Amount', type: 'number', example: '1500000' },
  },
  channel_analytics: {
    channel: { vi: 'Kênh quảng cáo', en: 'Ad channel', type: 'text', example: 'facebook' },
    analytics_date: { vi: 'Ngày thống kê', en: 'Analytics date', type: 'date', example: '2026-01-15' },
    impressions: { vi: 'Lượt hiển thị', en: 'Impressions', type: 'number', example: '50000' },
    clicks: { vi: 'Lượt click', en: 'Clicks', type: 'number', example: '1200' },
    spend: { vi: 'Chi phí', en: 'Spend', type: 'number', example: '2000000' },
  },
  channel_fees: {
    fee_type: { vi: 'Loại phí (commission, payment, shipping...)', en: 'Fee type', type: 'text', example: 'commission' },
    amount: { vi: 'Số tiền phí', en: 'Fee amount', type: 'number', example: '50000' },
  },
  external_products: {
    name: { vi: 'Tên sản phẩm', en: 'Product name', type: 'text', example: 'Giày thể thao nam' },
    selling_price: { vi: 'Giá bán', en: 'Selling price', type: 'number', example: '850000' },
    cost_price: { vi: 'Giá vốn', en: 'Cost price', type: 'number', example: '500000' },
  },
  channel_settlements: {
