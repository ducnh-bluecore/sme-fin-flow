  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Trung tâm điều hành - Quyết định tài chính" />
      </Helmet>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Trung tâm điều hành — Quyết định tài chính
                </p>
              </div>
            </div>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="space-y-3">
                ...
                {/* Show more */}
                {!showAll && allCards?.length > 7 && (
                  <Button
                    variant="ghost"
                    className="w-full text-muted-foreground"
                    onClick={() => setShowAll(true)}
                  >
                    Xem thêm {allCards.length - 7} quyết định
                  </Button>
                )}
              </div>
            ) : (
