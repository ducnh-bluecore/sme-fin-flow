...
const formulas: Formula[] = [
  ...
  // Cash Flow Direct (Dòng tiền trực tiếp)
  {
    id: 'net-cash-operating',
    name: 'Net Cash from Operating',
    nameVi: 'Dòng tiền thuần từ hoạt động kinh doanh',
    formula: 'NCO = Thu từ KH + Thu lãi + Thu khác - Chi NCC - Chi lương - Chi lãi - Chi thuế - Chi thuê - Chi điện nước - Chi khác',
    description: 'Dòng tiền thuần từ hoạt động kinh doanh theo phương pháp trực tiếp.',
    variables: [
      { name: 'Thu từ KH', meaning: 'Tiền thu từ bán hàng, cung cấp dịch vụ' },
      { name: 'Chi NCC', meaning: 'Tiền chi trả nhà cung cấp' },
      { name: 'Chi lương', meaning: 'Tiền chi trả cho nhân viên' },
      { name: 'Chi lãi', meaning: 'Tiền chi trả lãi vay' },
      { name: 'Chi thuế', meaning: 'Tiền nộp thuế' },
    ],
    example: 'Thu KH 5B, Chi NCC 2B, Lương 1B, Thuế 300M → NCO = 5 - 2 - 1 - 0.3 = 1.7B',
    usedIn: ['Cash Flow Direct', 'CFO Dashboard'],
    category: 'cash-flow-direct',
  },
  {
    id: 'net-cash-investing',
    name: 'Net Cash from Investing',
    nameVi: 'Dòng tiền thuần từ hoạt động đầu tư',
    formula: 'NCI = Thu bán TSCĐ + Thu thu hồi đầu tư - Chi mua TSCĐ - Chi đầu tư',
    description: 'Dòng tiền từ mua bán tài sản cố định và đầu tư.',
    variables: [
      { name: 'Thu bán TSCĐ', meaning: 'Tiền thu từ thanh lý tài sản cố định' },
      { name: 'Chi mua TSCĐ', meaning: 'Tiền chi mua tài sản cố định, thiết bị' },
      { name: 'Chi đầu tư', meaning: 'Tiền chi đầu tư vào công ty khác' },
    ],
    usedIn: ['Cash Flow Direct', 'Capital Allocation'],
    category: 'cash-flow-direct',
  },
  {
    id: 'net-cash-financing',
    name: 'Net Cash from Financing',
    nameVi: 'Dòng tiền thuần từ hoạt động tài chính',
    formula: 'NCF = Thu vay + Thu phát hành CP - Chi trả nợ gốc - Chi cổ tức',
    description: 'Dòng tiền từ hoạt động vay nợ, phát hành cổ phiếu và chi trả cổ tức.',
    variables: [
      { name: 'Thu vay', meaning: 'Tiền thu từ vay ngân hàng, phát hành trái phiếu' },
      { name: 'Thu phát hành CP', meaning: 'Tiền thu từ phát hành cổ phiếu' },
      { name: 'Chi trả nợ gốc', meaning: 'Tiền chi trả nợ gốc vay' },
      { name: 'Chi cổ tức', meaning: 'Tiền chi trả cổ tức cho cổ đông' },
    ],
    usedIn: ['Cash Flow Direct', 'Covenant Tracking'],
    category: 'cash-flow-direct',
  },
  {
    id: 'closing-cash-balance',
    name: 'Closing Cash Balance',
    nameVi: 'Số dư tiền cuối kỳ',
    formula: 'Cuối kỳ = Đầu kỳ + NCO + NCI + NCF',
    description: 'Số dư tiền mặt và tương đương tiền cuối kỳ.',
    variables: [
      { name: 'Đầu kỳ', meaning: 'Số dư tiền đầu kỳ' },
      { name: 'NCO', meaning: 'Dòng tiền thuần hoạt động kinh doanh' },
      { name: 'NCI', meaning: 'Dòng tiền thuần hoạt động đầu tư' },
      { name: 'NCF', meaning: 'Dòng tiền thuần hoạt động tài chính' },
    ],
    example: 'Đầu kỳ 2B, NCO +1.7B, NCI -500M, NCF -200M → Cuối kỳ = 2 + 1.7 - 0.5 - 0.2 = 3B',
    usedIn: ['Cash Flow Direct', 'Cash Forecast'],
    category: 'cash-flow-direct',
  },
  {
    id: 'operating-cash-ratio',
    name: 'Operating Cash Ratio',
    nameVi: 'Tỷ lệ tiền từ hoạt động/Nợ ngắn hạn',
    formula: 'OCR = Dòng tiền hoạt động / Nợ ngắn hạn bình quân',
    description: 'Khả năng thanh toán nợ ngắn hạn bằng dòng tiền từ hoạt động. > 1 là tốt.',
    variables: [
      { name: 'Dòng tiền HĐ', meaning: 'Dòng tiền thuần từ hoạt động kinh doanh' },
      { name: 'Nợ NH BQ', meaning: 'Nợ ngắn hạn bình quân trong kỳ' },
    ],
    example: 'NCO = 1.7B, Nợ NH = 1B → OCR = 1.7 (Tốt)',
    usedIn: ['Cash Flow Direct', 'Working Capital'],
    category: 'cash-flow-direct',
  },

  // Retail Operations - Inventory Aging
  {
    id: 'inventory-aging-ratio',
    name: 'Inventory Aging Ratio',
    nameVi: 'Tỷ lệ tồn kho theo tuổi',
    formula: 'Aging% = Giá trị tồn kho trong bucket / Tổng giá trị tồn kho × 100',
    description: 'Phân bổ tồn kho theo độ tuổi để xác định hàng chậm luân chuyển.',
    variables: [
      { name: 'Bucket', meaning: 'Khoảng thời gian (0-30, 31-60, 61-90, >90 ngày)' },
      { name: 'Giá trị trong bucket', meaning: 'Tổng giá trị SKU trong khoảng tuổi đó' },
    ],
    example: 'Tồn kho >90 ngày = 200M, Tổng = 1B → Aging% = 20%',
    usedIn: ['Inventory Aging', 'Working Capital'],
    category: 'retail-ops',
  },
  {
    id: 'slow-moving-inventory',
    name: 'Slow Moving Inventory',
    nameVi: 'Tồn kho chậm luân chuyển',
    formula: 'SMI = Σ(SKU có tuổi > Ngưỡng)',
    description: 'Giá trị tồn kho không bán được trong thời gian dài (thường >90 ngày).',
    variables: [
      { name: 'Ngưỡng', meaning: 'Số ngày xác định hàng chậm (thường 90 ngày)' },
      { name: 'SKU', meaning: 'Mã sản phẩm' },
    ],
    usedIn: ['Inventory Aging', 'Cash Conversion Cycle'],
    category: 'retail-ops',
  },
  {
    ...
    formula: 'IT = COGS / Tồn kho bình quân',
    description: 'Số lần tồn kho được bán và thay thế trong kỳ. Cao = hiệu quả.',
    variables: [
      { name: 'COGS', meaning: 'Giá vốn hàng bán' },
      { name: 'Tồn kho BQ', meaning: '(Tồn kho đầu kỳ + Cuối kỳ) / 2' },
    ],
    example: 'COGS = 10B, Tồn kho BQ = 2B → IT = 5 vòng/năm',
    usedIn: ['Inventory Aging', 'DIO Calculation'],
    category: 'retail-ops',
  },

  // Retail Operations - Promotion ROI
  {
    id: 'promotion-roi',
    name: 'Promotion ROI',
    nameVi: 'ROI chương trình khuyến mãi',
    formula: 'ROI = (Doanh thu KM - Chi phí KM) / Chi phí KM × 100%',
    description: 'Hiệu quả đầu tư của chương trình khuyến mãi.',
    variables: [
      { name: 'Doanh thu KM', meaning: 'Doanh thu trong thời gian khuyến mãi' },
      { name: 'Chi phí KM', meaning: 'Chi phí voucher + quà tặng + marketing' },
    ],
    example: 'Doanh thu = 500M, Chi phí = 100M → ROI = (500-100)/100 = 400%',
    usedIn: ['Promotion ROI', 'Marketing Analytics'],
    category: 'retail-ops',
  },
  {
    id: 'promotion-roas',
    name: 'Promotion ROAS',
    nameVi: 'ROAS khuyến mãi',
    formula: 'ROAS = Doanh thu KM / Chi phí KM',
    description: 'Doanh thu thu được cho mỗi đồng chi cho khuyến mãi.',
    variables: [
      { name: 'Doanh thu KM', meaning: 'Doanh thu từ chiến dịch khuyến mãi' },
      { name: 'Chi phí KM', meaning: 'Tổng chi phí cho khuyến mãi' },
    ],
    example: 'Doanh thu = 500M, Chi phí = 100M → ROAS = 5x',
    usedIn: ['Promotion ROI', 'Channel Analytics'],
    category: 'retail-ops',
  },
  {
    id: 'conversion-uplift',
    name: 'Conversion Uplift',
    nameVi: 'Tăng tỷ lệ chuyển đổi',
    formula: 'Uplift = (CR_KM - CR_Base) / CR_Base × 100%',
    description: 'Phần trăm tăng tỷ lệ chuyển đổi nhờ khuyến mãi.',
    variables: [
      { name: 'CR_KM', meaning: 'Tỷ lệ chuyển đổi trong KM' },
      { name: 'CR_Base', meaning: 'Tỷ lệ chuyển đổi bình thường' },
    ],
    example: 'CR_KM = 5%, CR_Base = 3% → Uplift = (5-3)/3 = 66.7%',
    usedIn: ['Promotion ROI', 'Channel Analytics'],
    category: 'retail-ops',
  },
  {
    id: 'basket-size-impact',
    name: 'Basket Size Impact',
    nameVi: 'Tác động giá trị giỏ hàng',
    formula: 'Impact = (AOV_KM - AOV_Base) / AOV_Base × 100%',
    description: 'Phần trăm thay đổi giá trị đơn hàng trung bình khi có khuyến mãi.',
    variables: [
      { name: 'AOV_KM', meaning: 'AOV trong thời gian khuyến mãi' },
      { name: 'AOV_Base', meaning: 'AOV bình thường' },
    ],
    usedIn: ['Promotion ROI', 'Unit Economics'],
    category: 'retail-ops',
  },

  // Retail Operations - Supplier Payments
  {
    id: 'supplier-payment-compliance',
    name: 'Payment Compliance Rate',
    nameVi: 'Tỷ lệ thanh toán đúng hạn',
    formula: 'PCR = Số hóa đơn thanh toán đúng hạn / Tổng số hóa đơn × 100%',
    description: 'Đo lường mức độ tuân thủ thanh toán đúng hạn cho nhà cung cấp.',
    variables: [
      { name: 'Đúng hạn', meaning: 'Thanh toán trước hoặc đúng ngày đến hạn' },
      { name: 'Tổng HĐ', meaning: 'Tổng số hóa đơn cần thanh toán' },
    ],
    example: '95 hóa đơn đúng hạn / 100 tổng → PCR = 95%',
    usedIn: ['Supplier Payments', 'AP Operations'],
    category: 'retail-ops',
  },
  {
    id: 'early-payment-discount',
    name: 'Early Payment Discount',
    nameVi: 'Chiết khấu thanh toán sớm',
    formula: 'APR = (Discount% / (100% - Discount%)) × (365 / (Full - Discount Days))',
    description: 'Lãi suất quy đổi hàng năm của chiết khấu thanh toán sớm.',
    variables: [
      { name: 'Discount%', meaning: 'Tỷ lệ chiết khấu (thường 2%)' },
      { name: 'Full Days', meaning: 'Số ngày thanh toán full (thường 30)' },
      { name: 'Discount Days', meaning: 'Số ngày để nhận chiết khấu (thường 10)' },
    ],
    example: '2/10 net 30: APR = (2/98) × (365/20) = 37.2%/năm',
    usedIn: ['Supplier Payments', 'Cash Management'],
    category: 'retail-ops',
  },
  {
    id: 'weighted-avg-payment-term',
    name: 'Weighted Average Payment Term',
    nameVi: 'Kỳ hạn thanh toán bình quân gia quyền',
    formula: 'WAPT = Σ(Giá trị HĐ × Số ngày thanh toán) / Tổng giá trị',
    description: 'Số ngày thanh toán bình quân tính theo giá trị hóa đơn.',
    variables: [
      { name: 'Giá trị HĐ', meaning: 'Giá trị từng hóa đơn' },
      { name: 'Số ngày', meaning: 'Số ngày từ ngày hóa đơn đến ngày thanh toán' },
    ],
    usedIn: ['Supplier Payments', 'DPO Calculation'],
    category: 'retail-ops',
  },
  {
    id: 'supplier-concentration',
    name: 'Supplier Concentration',
    nameVi: 'Mức độ tập trung nhà cung cấp',
    formula: 'SC = Giá trị mua từ NCC lớn nhất / Tổng giá trị mua × 100%',
    description: 'Đo lường rủi ro phụ thuộc vào một số ít nhà cung cấp.',
    variables: [
      { name: 'Top NCC', meaning: 'Giá trị mua từ nhà cung cấp lớn nhất' },
      { name: 'Tổng', meaning: 'Tổng giá trị mua hàng' },
    ],
    example: 'NCC lớn nhất = 2B, Tổng = 10B → SC = 20%',
    usedIn: ['Supplier Payments', 'Risk Dashboard'],
    category: 'retail-ops',
  },
...
const categories = [
  ...
  { id: 'cash-flow-direct', label: 'Dòng tiền trực tiếp', icon: Banknote },
  { id: 'retail-ops', label: 'Vận hành bán lẻ', icon: Package },
