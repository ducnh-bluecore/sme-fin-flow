...
export function useDecideCard() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (isAutoGenerated) {
        // For auto-generated cards, just log the decision without DB operations
        console.log('Decision made on auto-generated card:', { cardId, actionType, actionLabel, comment });
...
export function useDismissCard() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (isAutoGenerated) {
        // For auto-generated cards, just log the dismissal without DB operations
        console.log('Dismissed auto-generated card:', { cardId, reason, comment });
...
export function useSnoozeCard() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (isAutoGenerated) {
        // For auto-generated cards, just log the snooze without DB operations
        console.log('Snoozed auto-generated card:', { cardId, hours, snoozedUntil });
