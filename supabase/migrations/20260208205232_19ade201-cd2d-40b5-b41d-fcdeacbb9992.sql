...
BEGIN
  ...
  inserted AS (
    ...
    SELECT
      ...
      CASE WHEN f.orders_90d > 0 THEN ROUND(f.revenue_90d / f.orders_90d, 2) ELSE 0 END,
      f.recency_days::INT, f.orders_180d, f.revenue_180d,
      ...
      jsonb_build_object('has_cogs', f.has_cogs, 'margin_source', f.margin_source,
        ...
        'data_span_days', ROUND(f.data_span_days), 'tenant_margin_rate', ROUND(v_tenant_margin_rate, 4)),
