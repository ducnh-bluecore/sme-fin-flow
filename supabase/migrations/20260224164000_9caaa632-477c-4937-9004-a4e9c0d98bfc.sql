...
DECLARE
  ...
  allowed_tables text[] := ARRAY[
    ...
    'inv_stores', 'inv_family_codes', 'inv_store_products', 'inv_import_batches',
    'inv_import_items', 'inv_daily_sales', 'inv_daily_stock',
    'kpi_facts_daily', 'cdp_customers', 'alert_instances',
    'cdp_customer_equity_computed', 'information_schema',
    'stores', 'store_daily_metrics'
  ];
  table_name text;
...
BEGIN
  ...
  IF lower_query ~ 'information_schema' THEN
    is_allowed := true;
  END IF;
