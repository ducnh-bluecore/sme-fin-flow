    ...
    ARRAY(SELECT format(
      ...
      CASE 
        ...
        WHEN c IN ('cost_price', 'selling_price', 'current_stock', 'quantity', 'unit_price', 'total_price',
                   ...
                   'opening_qty', 'closing_qty', 'movement_qty', 'snapshot_qty', 'snapshot_value') THEN 'numeric'
        WHEN c IN ('is_active', 'is_cod', 'is_first_order', 'is_verified') THEN 'boolean'
...
GRANT EXECUTE ON FUNCTION public.tenant_upsert_jsonb(uuid, text, jsonb, text[]) TO service_role;
