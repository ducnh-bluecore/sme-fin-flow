...
-- Fix: expenses table has no is_variable column, use category-based logic instead
...
BEGIN
  ...
  -- 3. AR from cdp_orders (RETAIL: orders = invoices)
  ...
  -- 7. Expenses (FIX: no is_variable column, use category-based variable cost detection)
  SELECT 
