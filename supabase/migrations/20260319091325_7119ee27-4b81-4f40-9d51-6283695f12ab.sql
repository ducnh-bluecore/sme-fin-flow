...
BEGIN
  ...
  -- Check if we have ads data and compute historical average
  ...
  -- p_ads_spend is now treated as ADDITIONAL ads spend on top of historical baseline
  FOR i IN 0..(p_horizon_months - 1) LOOP
    ...
    BEGIN
      ...
      -- ads_revenue is only from ADDITIONAL spend (delta), not included in baseline
