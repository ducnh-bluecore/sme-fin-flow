...
-- Add index to speed up SKU prefix search
CREATE INDEX IF NOT EXISTS idx_cdp_order_items_tenant_sku ON public.cdp_order_items (tenant_id, sku text_pattern_ops);
