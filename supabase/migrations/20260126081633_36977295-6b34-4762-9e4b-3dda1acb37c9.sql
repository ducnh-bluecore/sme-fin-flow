...
-- ============================================================================
-- FIX: populate_central_metric_facts to match actual cdp_order_items schema
-- Columns: product_id (not sku), qty (not quantity), line_revenue, line_cogs, line_margin
-- ============================================================================
...
BEGIN
  ...
  -- Insert SKU-level facts (product_id as grain_id)
...
-- ============================================================================
-- FIX: populate_finance_monthly_summary - handle is_first_order column check
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    SELECT 
      ...
      COALESCE(order_agg.gross_profit - COALESCE(exp_agg.operating_expenses, 0), 0),
