...
-- Update cdp_evaluate_segments to handle dynamic research view rules
...
BEGIN
  ...
  LOOP
    ...
    IF v_segment.definition_json->>'source' = 'research_view' 
      ...
      FOR v_rule IN 
        SELECT * FROM jsonb_array_elements(v_segment.definition_json->'rules') AS r
      LOOP
        v_field := v_rule.r->>'field';
        v_value := v_rule.r->>'value';
