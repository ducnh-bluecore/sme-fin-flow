...
BEGIN
  ...
  -- ★ SCHEMA-AWARE: Route to tenant schema if provisioned
  v_tenant_schema := public.set_tenant_search_path(p_tenant_id);
  ...
  -- 1. REVENUE from cdp_orders (now schema-aware via search_path)
  SELECT 
  ...
  INSERT INTO public.central_metrics_snapshots (
    ...
    v_start_date, v_end_date, 'compute_central_metrics_snapshot_v1.5', v_duration_ms,
    'v1.5-schema-aware', 'compute_central_metrics_snapshot',
